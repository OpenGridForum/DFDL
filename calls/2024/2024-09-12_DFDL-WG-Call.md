# OGF DFDL Working Group Call Agenda and Minutes 12 Sept 2024
...
### Meeting closed
12:00 EDT.US (estimated)

### Next regular call (Normally, monthly on 2nd Thursday)

Note that there was no meeting in July nor August. 

10 Oct 2024 11:00 EDT.US (UTC-4)
...
1. Discussed the work required for the ISO version of the DFDL spec and getting it
  out of MS-Word is something that probably needs motivating by important 
  new additions to the spec, such as the offset/pointers feature that has
  been implemented by the IBM zTPF DFDL. 
2. Mike Beckerle suggested a second implementation of these features in 
  Apache Daffodil is getting to be high priority.  
