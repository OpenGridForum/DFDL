# OGF DFDL Working Group Call Minutes 22-June-2023
...
### Next regular call
14-Sept-2023 @ 11:00 EDT.US

## Agenda

1. Implementations Update

No IBM Implementation updates.
Apache Daffodil 3.5.0 release will be soon.

2. Review of updated DFDL 1.0 spec with errata

Looked at the change-bars/change-markings and consensus that this is useful currently. A future ISO-formatted version seems the right time to remove the change markings.

3. AOB

Deferring these regular spec/issues calls for summer.
ISO calls will continue during summer.
